...
export namespace Prisma {
  ...
  */
  ...
  export type FamilyCountOutputTypeGetPayload<
    S extends boolean | null | undefined | FamilyCountOutputTypeArgs,
    U = keyof S
      > = S extends true
        ? FamilyCountOutputType
    : S extends undefined
    ? never
    : S extends FamilyCountOutputTypeArgs
    ?'include' extends U
    ? FamilyCountOutputType 
    : 'select' extends U
    ? {
  ...
  export type UserGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        P extends 'family' ? FamilyGetPayload<Exclude<S['include'], undefined | null>[P]> | null :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'family' ? FamilyGetPayload<Exclude<S['select'], undefined | null>[P]> | null :  P extends keyof User ? User[P] : never
  } 
    : User
  : User
  ...
  export class Prisma__UserClient<T, Null = never> implements PrismaPromise<T> {
    ...
    family<T extends FamilyArgs = {}>(args?: Subset<T, FamilyArgs>): CheckSelect<T, Prisma__FamilyClient<Family | Null>, Prisma__FamilyClient<FamilyGetPayload<T> | Null>>;
  ...
  export type FamilyGetPayload<
    ...
    [P in TrueKeys<S['include']>]:
        ...
        P extends '_count' ? FamilyCountOutputTypeGetPayload<Exclude<S['include'], undefined | null>[P]> :  never
  } 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'users' ? Array < UserGetPayload<Exclude<S['select'], undefined | null>[P]>>  :
        P extends '_count' ? FamilyCountOutputTypeGetPayload<Exclude<S['select'], undefined | null>[P]> :  P extends keyof Family ? Family[P] : never
  } 
    : Family
  : Family
  ...
  export interface FamilyDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Family'> extends True ? CheckSelect<T, Prisma__FamilyClient<Family>, Prisma__FamilyClient<FamilyGetPayload<T>>> : CheckSelect<T, Prisma__FamilyClient<Family | null, null>, Prisma__FamilyClient<FamilyGetPayload<T> | null, null>>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Family'> extends True ? CheckSelect<T, Prisma__FamilyClient<Family>, Prisma__FamilyClient<FamilyGetPayload<T>>> : CheckSelect<T, Prisma__FamilyClient<Family | null, null>, Prisma__FamilyClient<FamilyGetPayload<T> | null, null>>
    ...
    **/
    ...
    /**
     * Find one Family that matches the filter or throw
     * `NotFoundError` if no matches were found.
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FamilyClient<T, Null = never> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type FamilyFindUniqueOrThrowArgs = FamilyFindUniqueArgsBase
      

  /**
   * Family: findFirstOrThrow
   */
  export type FamilyFindFirstOrThrowArgs = FamilyFindFirstArgsBase
  ...
  export type UserWhereInput = {
    ...
    isOnboarding?: BoolFilter | boolean
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    isOnboarding?: BoolWithAggregatesFilter | boolean
  ...
  export type UserUpdateInput = {
    ...
    isOnboarding?: BoolFieldUpdateOperationsInput | boolean
